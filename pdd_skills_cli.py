...
def main() -> int:
    ...
    p_store.add_argument("--output-csv", dest="output_csv", default=None, help="完整流程时写入表格路径（CSV/XLSX）")
    ...
    p_stores = sub.add_parser("dump-stores", help="依次获取多个店铺商品信息并汇总到一个表格（CSV/XLSX）")
